...
const Specifications = () => {
    ...
    const BaseApi = api_Routes.specifications.view
                ...
                setdress(prev=>[...prev,{
                    ...
                    action: (
                        <div>
                          ...
                          <span style={{paddingLeft:"15px"}} onClick={()=>{navigate(`/EditSpecification/${elem.id}`)}}>
    ...
    const handleDeleteConfirmed = async () => {
        const {response, message} = await Helper.Delete({
          url:api_Routes.specifications.bulkDelete(recordIdToDelete),
          hasToken:true,
        })
        if(response){
    ...
    return(
        ...
        <Dialog open={openDialog} onClose={handleCloseDialog}>
          ...
          <DialogContent>
            <Typography>Are you sure you want to delete this Specification?</Typography>
          </DialogContent>
          <DialogActions>
        ...
        <Container sx={{marginBottom:"20px"}}>
            <Grid container sx={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                <Grid item>
                  <Typography sx={{fontSize:"28px" , fontWeight:"600" , color:"#1e1b1b"}} >Specifications</Typography>
                </Grid>
                <Grid item >
                  <Button variant="contained" startIcon={<AddIcon />} sx={{backgroundColor:"#0A722E",fontSize:"13px",borderRadius:"7px",height:"38px",'&:hover': {  backgroundColor: "#0A722E"  }}} onClick={()=> {navigate('/AddSpecification')}}>
                    Add Specification
                  </Button>
                </Grid>
            </Grid>
